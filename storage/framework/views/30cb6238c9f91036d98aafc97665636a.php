<?php $__env->startSection('title', 'Kasir - Pilih Produk'); ?>
...
<div class="container">
        ...
        <div class="hero-head">
            <div class="hero-copy">
                <div class="hero-logo-wrap">
                    <?php if($logoPath !== ''): ?>
                        <div class="hero-logo">
                            <img src="<?php echo e(asset('storage/' . $logoPath)); ?>" alt="Logo Cafe">
                        </div>
                    <?php endif; ?>
                ...
                <div class="hero-stats-line">
                    <span class="stat-chip">Produk <strong><?php echo e(number_format($produkCount, 0, ',', '.')); ?></strong></span>
                    <span class="stat-chip">Kategori <strong><?php echo e(number_format($kategoriCount, 0, ',', '.')); ?></strong></span>
                    <?php if($bundlingCount > 0): ?>
                    <span class="stat-chip">Bundling <strong><?php echo e(number_format($bundlingCount, 0, ',', '.')); ?></strong></span>
                    <?php endif; ?>
                    <span class="stat-chip">Shift <strong><?php echo e($shiftBadge); ?></strong></span>
                </div>
            </div>
            <div class="hero-side">
                <?php if(auth()->user()->role !== 'admin' && !empty($activeShift)): ?>
                    <div class="shift-flip" id="shiftFlip">
                        <div class="shift-flip-card" role="button" aria-label="Detail kas shift" tabindex="0">
                            <span class="shift-face front">
                                ...
                                Shift <?php echo e((int) $activeShift->shift_ke); ?> | Kas Awal Rp <?php echo e(number_format((float) $activeShift->kas_awal, 0, ',', '.')); ?>

                            </span>
                            <span class="shift-face back">
                                <span class="shift-dot"></span>
                                Shift <?php echo e((int) $activeShift->shift_ke); ?> | Kas Sekarang Rp <?php echo e(number_format((float) ($kasSekarang ?? $activeShift->kas_awal), 0, ',', '.')); ?>

                            </span>
                        </div>
                    </div>
                    <a class="btn-neutral" href="<?php echo e(route('kasir.shift.report')); ?>">Tutup Shift</a>
                <?php endif; ?>
            </div>
        </div>
        <div class="nav">
            <?php echo $__env->make('partials.top-nav-links', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
    </div>
    <?php else: ?>
    ...
    <div class="admin-page-head" style="margin-bottom:1rem;">
        ...
        <div class="admin-page-actions">
            <span class="admin-chip">Produk: <?php echo e($produkCount); ?></span>
            <span class="admin-chip">Kategori: <?php echo e($kategoriCount); ?></span>
            <span class="admin-chip soft"><?php echo e($shiftBadge); ?></span>
        </div>
    </div>
    <?php endif; ?>
    ...
    <?php if(($promoAnnouncements ?? collect())->count() > 0): ?>
        <section class="promo-board">
            ...
            <div class="promo-grid">
                <?php $__currentLoopData = $promoAnnouncements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $promo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                    ...
                    <article class="promo-card">
                        ...
                        <span class="promo-pill <?php echo e($statusClass); ?>"><?php echo e($statusLabel); ?></span>
                        <?php if(!empty($promo->image_path)): ?>
                            <img class="promo-thumb" src="<?php echo e(asset('storage/' . $promo->image_path)); ?>" alt="Poster promo">
                        <?php endif; ?>
                        <div class="promo-body"><?php echo e($bodyPreview); ?></div>
                        <?php if($publishedAt): ?>
                            <div class="promo-meta"><?php echo e($publishedAt); ?></div>
                        <?php endif; ?>
                    </article>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
    ...
    <form id="kasirForm" method="post" action="<?php echo e(route(($kasirRoutePrefix ?? 'kasir') . '.preview')); ?>">
        <?php echo csrf_field(); ?>
        <input type="hidden" id="selectedBundlingInput" name="id_promo_bundling" value="<?php echo e((int) ($selectedBundlingId ?? 0)); ?>">
        ...
        <div class="panel transaction-panel">
            ...
            <div class="kategori-nav">
                <?php if(($promoBundling ?? collect())->count() > 0): ?>
                    <a href="#kategori-bundling">Bundling (<?php echo e(($promoBundling ?? collect())->count()); ?>)</a>
                <?php endif; ?>
                <?php $__currentLoopData = $produkByKategori; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $groupKategori): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="#kategori-<?php echo e($groupKategori['slug']); ?>"><?php echo e($groupKategori['nama']); ?> (<?php echo e($groupKategori['items']->count()); ?>)</a>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
            ...
            <div class="layout">
                <div class="menu-list">
                    ...
                    <?php if(($promoBundling ?? collect())->count() > 0): ?>
                        <section id="kategori-bundling" class="kategori-block">
                            ...
                            <div class="grid">
                                <?php $__currentLoopData = ($promoBundling ?? collect()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bundle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                    ...
                                    <div class="card bundle-card">
                                        <div class="card-head">
                                            ...
                                            <div class="title"><?php echo e($bundle->nama_promo); ?></div>
                                        ...
                                        <div class="meta meta-pills">
                                            <span class="meta-pill price">Rp <?php echo e(number_format((float) $bundle->harga_bundle, 0, ',', '.')); ?></span>
                                            <span class="meta-pill save">Hemat Rp <?php echo e(number_format($hemat, 0, ',', '.')); ?></span>
                                        </div>
                                        <div class="picked">
                                            <span class="picked-label">Isi bundling</span>
                                            <?php $__currentLoopData = $bundle->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $it): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="picked-item compact">
                                                    <div><?php echo e($it->produk?->nama_produk ?? '-'); ?></div>
                                                    <div>x<?php echo e((int) $it->qty); ?></div>
                                                </div>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </div>
                                        <div class="card-actions">
                                            <button
                                                ...
                                                data-bundling-id="<?php echo e($bundle->id_promo_bundling); ?>"
                                                data-bundling-name="<?php echo e($bundle->nama_promo); ?>"
                                                data-bundling-price="<?php echo e((float) $bundle->harga_bundle); ?>"
                                                data-bundling-items='<?php echo e($bundleItemsPayload); ?>'
                                            >Tambah</button>
                                            <button
                                                type="button"
                    ...
                    <?php $__currentLoopData = $produkByKategori; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $groupKategori): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <section id="kategori-<?php echo e($groupKategori['slug']); ?>" class="kategori-block">
                            <h3 class="kategori-title"><?php echo e($groupKategori['nama']); ?></h3>
                            <div class="grid">
                                <?php $__currentLoopData = $groupKategori['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                    ...
                                    <div class="card js-product-card"
                                         ...
                                         data-harga="<?php echo e((float) $item->harga); ?>"
                                         data-stok="<?php echo e((int) ($item->stok ?? 0)); ?>"
                                         data-temperature-enabled="<?php echo e($item->is_temperature_enabled ? 1 : 0); ?>"
                                         data-sugar-enabled="<?php echo e($item->is_sugar_enabled ? 1 : 0); ?>"
                                         data-cup-enabled="<?php echo e($item->is_cup_size_enabled ? 1 : 0); ?>"
                                         data-spicy-enabled="<?php echo e($item->is_spicy_enabled ? 1 : 0); ?>"
                                         data-temperature-options='<?php echo json_encode($item->resolvedTemperatureOptions(), 15, 512) ?>'
                                         data-sugar-options='<?php echo json_encode($item->resolvedSugarOptions(), 15, 512) ?>'
                                         data-cup-options='<?php echo json_encode($item->resolvedCupSizeOptions(), 15, 512) ?>'
                                         data-spicy-options='<?php echo json_encode($item->resolvedSpicyOptions(), 15, 512) ?>'
                                         data-custom-groups='<?php echo json_encode($item->resolvedCustomOptionGroups(), 15, 512) ?>'>
                                        <div class="card-head">
                                            <div class="card-kicker"><?php echo e($groupKategori['nama']); ?></div>
                                            <div class="title"><?php echo e($item->nama_produk); ?></div>
                                            <?php if($varianList->isNotEmpty()): ?>
                                                <div class="card-varian-tags">
                                                    <?php $__currentLoopData = $varianList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <span class="card-varian-tag"><?php echo e($v); ?></span>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </div>
                                            <?php endif; ?>
                                        </div>
                                        <div class="meta meta-pills">
                                            <span class="meta-pill price">Rp <?php echo e(number_format((float)$item->harga, 0, ',', '.')); ?></span>
                                            <span class="meta-pill stock <?php echo e($stokClass); ?>">Stok <?php echo e($item->stok); ?></span>
                                        </div>
                                        <div class="picked">
                ...
                <aside class="summary">
                    ...
                    <div class="row"><span>Paket Bundling</span><strong id="sumBundling"><?php echo e($selectedBundlingName ?? '-'); ?></strong></div>
...
(function () {
    ...
    const initialSessionItems = <?php echo json_encode($selectedLines ?? [], 15, 512) ?>;
    const initialOldItems = <?php echo json_encode(old('items', []), 512) ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\psrnl\laravel\kasir\resources\views/kasir/index.blade.php ENDPATH**/ ?>