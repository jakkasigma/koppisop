...
<header class="admin-topbar">
    ...
    <div class="admin-topbar-actions">
        ...
        <a class="admin-topbar-btn" href="<?php echo e(route('dashboard.chat.index')); ?>">Inbox</a>
        <a class="admin-topbar-btn primary" href="<?php echo e(route('dashboard.index')); ?>">Dashboard</a>
    </div>
</header>
