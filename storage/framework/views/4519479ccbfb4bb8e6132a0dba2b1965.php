...
<head>
    ...
    ?>
    <meta name="theme-color" content="<?php echo e($themePrimary); ?>">
    ...
    ?>
    <?php if(request()->routeIs('kasir.*') || request()->routeIs('admin.kasir.*')): ?>
        <?php echo app('Illuminate\Foundation\Vite')('resources/css/kasir.css'); ?>
    <?php endif; ?>
    <?php if(request()->routeIs('transaksi.*') && !$isAdminCss): ?>
        <?php echo app('Illuminate\Foundation\Vite')('resources/css/transaksi.css'); ?>
    <?php endif; ?>
    <?php if($isAdminCss): ?>
        ...
        <?php echo app('Illuminate\Foundation\Vite')(['resources/css/admin.css', 'resources/js/date-picker.js']); ?>
    <?php endif; ?>
    <style>
        :root {
            --bg:<?php echo e($themeBg); ?>;
            --ink:#0f172a;
            --line:#d7e4e2;
            --panel:#ffffff;
            --muted:#64748b;
            --danger:#dc2626;
            --accent:<?php echo e($themePrimary); ?>;
            --accent-2:<?php echo e($themeSecondary); ?>;
        }
    ...
    <div class="quick-menu" id="quickMenu">
        ...
        <div class="quick-menu-panel" id="quickMenuPanel">
            <div class="item is-static">
                <div class="quick-menu-name"><?php echo e($quickName); ?></div>
            </div>
            <div class="sep"></div>
            <?php if(auth()->check()): ?>
                <a class="item accent" href="<?php echo e(route('cafe_profile.edit')); ?>">Profil Cafe</a>
                <a class="item accent" href="<?php echo e(route('theme_setting.edit')); ?>">Tema Aplikasi</a>
                <a class="item accent" href="<?php echo e(route('dashboard.chat.index')); ?>">Chat Karyawan</a>
                <a class="item" href="<?php echo e(route('dashboard.staff_activity.index')); ?>">Aktivitas Staf</a>
                <a class="item" href="<?php echo e(route('dashboard.workspace')); ?>">Ruang Kerja</a>
                <a class="item" href="<?php echo e(route('dashboard.index')); ?>">Kembali ke Dashboard</a>
...
<?php elseif(request()->routeIs('transaksi.*') && !$isAdmin): ?>
    
    <header class="trx-topbar">
        <span class="trx-topbar-title">Riwayat Transaksi</span>
        <div class="trx-topbar-actions">
            <a href="<?php echo e(route('kasir.index')); ?>" class="trx-topbar-btn">← Kasir</a>
            <form method="post" action="<?php echo e(route('logout')); ?>" onsubmit="return confirm('Logout?')" style="display:inline">
                <?php echo csrf_field(); ?>
...
<?php /**PATH D:\psrnl\laravel\kasir\resources\views/layouts/app.blade.php ENDPATH**/ ?>