...
@section('title', 'Tambah Promo Bundling')
...
<div class="container">
    <div class="admin-page-head">
        <div>
            ...
            <h1>Tambah Promo Bundling</h1>
            <p>Buat paket bundling dinamis untuk mempercepat penjualan paket.</p>
        </div>
    ...
    <div class="panel form-panel">
        ...
        @endif
        <form method="post" action="{{ route('bundling.store') }}" class="form-grid" id="formBundling">
            @csrf
